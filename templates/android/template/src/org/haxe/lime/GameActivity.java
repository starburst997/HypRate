...
public class GameActivity extends FragmentActivity implements SensorEventListener {
	...
	protected void onCreate (Bundle state) {
		...
		System.loadLibrary ("enhanceopenflextension");
		...
		if (extensions == null) {
			...
			extensions.add (new org.haxe.extension.EnhanceOpenFLExtension ());
	...
	public static int getResourceID (String inFilename) {
		...
		//
		//if (inFilename.equals("data/sounds/Angry.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_angry_ogg;
		//if (inFilename.equals("data/sounds/Ball_man_bad.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_ball_man_bad_ogg;
		//if (inFilename.equals("data/sounds/Ball_man_good.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_ball_man_good_ogg;
		//if (inFilename.equals("data/sounds/Bounce.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_bounce_ogg;
		//if (inFilename.equals("data/sounds/Bounce_soft.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_bounce_soft_ogg;
		//if (inFilename.equals("data/sounds/Button_click.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_button_click_ogg;
		//if (inFilename.equals("data/sounds/Fireworks.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_fireworks_ogg;
		//if (inFilename.equals("data/sounds/GameOver_meh.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_gameover_meh_ogg;
		//if (inFilename.equals("data/sounds/GameWin_start.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_gamewin_start_ogg;
		//if (inFilename.equals("data/sounds/GameWin_yay.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_gamewin_yay_ogg;
		//if (inFilename.equals("data/sounds/Hit_bird.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_bird_ogg;
		//if (inFilename.equals("data/sounds/Hit_cloud.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_cloud_ogg;
		//if (inFilename.equals("data/sounds/Hit_head.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_head_ogg;
		//if (inFilename.equals("data/sounds/Hit_metal.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_metal_ogg;
		//if (inFilename.equals("data/sounds/Hit_misc.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_misc_ogg;
		//if (inFilename.equals("data/sounds/Hit_owl.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_owl_ogg;
		//if (inFilename.equals("data/sounds/Hit_party.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_party_ogg;
		//if (inFilename.equals("data/sounds/Hit_powerups.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_powerups_ogg;
		//if (inFilename.equals("data/sounds/Hit_rain.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_rain_ogg;
		//if (inFilename.equals("data/sounds/Hit_static.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_static_ogg;
		//if (inFilename.equals("data/sounds/Hit_yodle.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_hit_yodle_ogg;
		//if (inFilename.equals("data/sounds/Music_forest.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_forest_ogg;
		//if (inFilename.equals("data/sounds/Music_GameOver.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_gameover_ogg;
		//if (inFilename.equals("data/sounds/Music_GameWin.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_gamewin_ogg;
		//if (inFilename.equals("data/sounds/Music_movies.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_movies_ogg;
		//if (inFilename.equals("data/sounds/Music_Overworld.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_overworld_ogg;
		//if (inFilename.equals("data/sounds/Music_residential.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_residential_ogg;
		//if (inFilename.equals("data/sounds/Music_urban.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_music_urban_ogg;
		//if (inFilename.equals("data/sounds/Pinball.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_pinball_ogg;
		//if (inFilename.equals("data/sounds/Prelude1.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_prelude1_ogg;
		//if (inFilename.equals("data/sounds/Shake.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_shake_ogg;
		//if (inFilename.equals("data/sounds/Star.ogg")) return com.failsafegames.pachinkrop.R.raw.data_sounds_star_ogg;
		//
		return -1;
